...
figure;
scatter(L(IQ_Labels==1,1),L(IQ_Labels==1,1),'r')
hold on
scatter(L(IQ_Labels==0,1),L(IQ_Labels==0,1),'b')
...
d_NN_train = d_NN_Reduced(sel_subs_train,:);
        ...
        KNNMdl = fitcknn(d_NN_train,IQ_Labels(sel_subs_train),'NumNeighbors',4909,'Distance','spearman');
...
% |=====================================================================================================|
% |    1 | Best   |     0.22713 |      2.4431 |     0.22713 |     0.22713 |           19 |   seuclidean |
% |    2 | Best   |       0.227 |      1.3575 |       0.227 |       0.227 |           22 |       cosine |
% |    3 | Best   |     0.21647 |      18.686 |     0.21647 |     0.21754 |         4909 |     spearman |
%% Bayesian
Accs = [];
d_NN_Reduced = L;
...
% |=====================================================================================================|
% |    1 | Best   |     0.49537 |      3.4277 |     0.49537 |     0.49537 |       kernel |   1.6296e-07 |
% |    2 | Best   |      0.3229 |     0.40231 |      0.3229 |     0.40909 |       normal |            - |
% |    3 | Best   |     0.21647 |      4.1109 |     0.21647 |     0.23173 |       kernel |     0.041518 |
% |    4 | Accept |      0.3229 |     0.15865 |     0.21647 |     0.21648 |       normal |            - |
% |    5 | Accept |     0.49592 |     0.66593 |     0.21647 |     0.21648 |       kernel |   8.5858e-10 |
% |    6 | Accept |     0.21647 |      3.7542 |     0.21647 |     0.21648 |       kernel |     0.041514 |
% |    7 | Best   |     0.21595 |      41.529 |     0.21595 |     0.21648 |       kernel |       3.0331 |